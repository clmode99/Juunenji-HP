		...
		<div class="header-inner">
			...
			<nav class="header-inner-right-mb-menu-list-outer">
				...
				<ol class="header-inner-right-mb-menu-list">
					...
					<li class="header-inner-right-mb-menu-item"><a href="grave.html">永代供養墓地</a></li>
					<li class="header-inner-right-mb-menu-item"><a href="traffic.html">交通のご案内</a></li>
					<li class="header-inner-right-mb-menu-item"><a>お問い合わせ</a></li>
					...
					<div class="main-line-add">
						...
						<div class="main-line-add-list">
							...
							<div class="main-line-add-item main-line-add-item-id">
								...
								<p class="main-line-add-item-text main-line-add-item-text-id">LINEアプリ「ホーム」から、<span class="br-tablet"></span>検索欄に「@185fmopx」で検索</p><!-- /.main-line-add-item-text -->
							</div><!-- /.main-line-add-item -->
		...
		<div class="footer-inner">
			...
			<div class="footer-inner-menu">
				<ol class="footer-inner-menu-list">
					...
					<li class="footer-inner-menu-item"><a>お問い合わせ</a></li><!-- /.footer-inner-menu-item -->
